...
export type Action = { readonly kind: 'basic' } | { readonly kind: 'skill'; readonly slot: number }
...
export function createBattle(allies: readonly Creature[], enemies: readonly Creature[]): BattleState {
  return {
    units: [
