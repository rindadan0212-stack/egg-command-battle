    ...
    public static class Traits
    {
        ...
        private static readonly Trait[] List =
        {
            ...
            new Trait("opener", "先駆け", TraitWhen.BattleStart,
                "戦闘の最初の1手で弱化が外れない",
                "スピードDOWN・全体・呪詛・スタン・大。⭐ **外れうる弱化ほど得** ── "
                + "開幕に1つだけ確実に通せるので、通りにくい札を先に切る判断が生まれる"),
            ...
            new Trait("desperation", "背水", TraitWhen.Always,
                "自分のHPが半分以下の間、技の待ちが速く減る",
                "全体連撃・スタン・大・蘇生。⭐ **重い技を持たせる理由**がここで生まれる ── "
            ...
            new Trait("tenacity", "粘り腰", TraitWhen.Always,
                "自分のHPが半分以下の間、受け取る回復が増える",
                "HP割合回復・リジェネ・立て直し。⭐ **回復役を連れているか**が編成の判断になる。"
                + "⚠️ 回復を持たない編成では何も起きない"),
        };
