...
namespace EggCommand.Core
{
    ...
    {
        /// <summary>同時に温められる数。⭐ **5枠（2-1-2 の菱形）**。
        ///
        /// ⚠️ 2026-08-19 に 5→6 へ 増やしたことがある。理由は
        /// 「5 だとホームで 3＋2 の不揃いになり、画面の余白も目立つ」だった。
        /// ⭐ **2026-08-27 に 5 へ戻した。**作者が描いたホーム画面が巣を
        /// **2-1-2 の菱形**に置いていて、3＋2 の不揃いという元の欠点がそもそも起きない
        /// ── 6 にした理由が消えたので戻せる（作者の確認済み「5枠にしていいよ」）。
        ///
        /// ⚠️ **減らす向きの変更なので、古いセーブに 5 番の枠が入っていることがある。**
        /// ⭐ 読み込み側（`Snapshot`）が枠の外の卵を棚へ戻す ── 黙って消さない。</summary>
